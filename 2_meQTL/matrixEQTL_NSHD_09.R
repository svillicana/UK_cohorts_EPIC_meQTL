...
# Output file name
output_file_name_cis <- paste("/mnt/lustre/groups/bell/epigenetics/Analysis/subprojects/sergio/UK_cohorts_meQTL/2_meQTL/NSHD/threshold_results_cis_chr",num,"_09esrc.txt",sep="");
output_file_name_trans <- paste("/mnt/lustre/groups/bell/epigenetics/Analysis/subprojects/sergio/UK_cohorts_meQTL/2_meQTL/NSHD/threshold_results_trans_chr",num,"_09esrc.txt",sep="");
...
write.table(maf.table,paste("/mnt/lustre/groups/bell/epigenetics/Analysis/subprojects/sergio/UK_cohorts_meQTL/2_meQTL/NSHD/MAF_chr",num,"_09esrc.txt",sep=""),quote=F,col.names=F,row.names=F,sep="\t")
...
R2 = r^2;
write.table(R2,paste("/mnt/lustre/groups/bell/epigenetics/Analysis/subprojects/sergio/UK_cohorts_meQTL/2_meQTL/NSHD/R2_cis_chr",num,"_09esrc.txt",sep=""),quote=F,col.names=F,row.names=F,sep="\t")
...
r = tstat / sqrt( dfFull + tstat^2 );
R2 = r^2;
write.table(R2,paste("/mnt/lustre/groups/bell/epigenetics/Analysis/subprojects/sergio/UK_cohorts_meQTL/2_meQTL/NSHD/R2_trans_chr",num,"_09esrc.txt",sep=""),quote=F,col.names=F,row.names=F,sep="\t")
