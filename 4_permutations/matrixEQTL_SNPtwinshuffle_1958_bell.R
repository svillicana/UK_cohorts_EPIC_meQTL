...
foreach (shi = 1:20, .packages="MatrixEQTL") %dopar%{
  ...
  # Output file name
  output_file_name_cis <- paste("/mnt/lustre/groups/bell/epigenetics/Analysis/subprojects/sergio/UK_cohorts_meQTL/4_permutations/1958/threshold_results_cis_chr",num,"_SNPtwinshuffle",shi,"_bell.txt",sep="");
  output_file_name_trans <- paste("/mnt/lustre/groups/bell/epigenetics/Analysis/subprojects/sergio/UK_cohorts_meQTL/4_permutations/1958/threshold_results_trans_chr",num,"_SNPtwinshuffle",shi,"_bell.txt",sep="");
