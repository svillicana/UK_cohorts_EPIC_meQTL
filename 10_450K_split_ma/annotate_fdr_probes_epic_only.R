...
filt_f <- "/scratch/prj/dtr/Groups_WorkSpace/JordanaBell/epigenetics/Analysis/subprojects/sergio/UK_cohorts_meQTL/10_450K_split_ma/probes_epic_only.txt"
...
# Save file
fwrite(cis, file = "/scratch/prj/dtr/Groups_WorkSpace/JordanaBell/epigenetics/Analysis/subprojects/sergio/UK_cohorts_meQTL/10_450K_split_ma/gwama_cis_random_filter_fdr0.05_n2_probes_epic_only.out",
...
# Save file
fwrite(trans, file = "/scratch/prj/dtr/Groups_WorkSpace/JordanaBell/epigenetics/Analysis/subprojects/sergio/UK_cohorts_meQTL/10_450K_split_ma/gwama_trans_random_filter_fdr0.05_n2_probes_epic_only.out",
       sep = "\t", row.names = FALSE, col.names = TRUE)
