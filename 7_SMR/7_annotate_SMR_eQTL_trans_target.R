...
# SMR eQTL
smr_eqtl <- fread(paste0(path,"7_SMR/Results/SMReQTL_trans_target/merge_results/SMReQTL_trans_target_filter_Bonf_0.05.txt"), data.table = F)
...
write.table(smr_eqtl_ann, paste0(path,"7_SMR/Results/SMReQTL_trans_target/merge_results/SMReQTL_trans_target_filter_Bonf_0.05_annotated.txt"),
  sep = "\t", col.names = T, row.names = F, quote = F)
write.table(smr_eqtl_enh, paste0(path,"7_SMR/Results/SMReQTL_trans_target/merge_results/SMReQTL_trans_target_enhancers.txt"),
  sep = "\t", col.names = T, row.names = F, quote = F)
write.table(smr_eqtl_epic, paste0(path,"7_SMR/Results/SMReQTL_trans_target/merge_results/SMReQTL_trans_target_epic.txt"),
  sep = "\t", col.names = T, row.names = F, quote = F)
write.table(smr_eqtl_enh_epic, paste0(path,"7_SMR/Results/SMReQTL_trans_target/merge_results/SMReQTL_trans_target_enhancers_epic.txt"),
  sep = "\t", col.names = T, row.names = F, quote = F)
